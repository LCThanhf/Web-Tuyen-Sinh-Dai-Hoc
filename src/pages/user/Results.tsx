...
const Results: React.FC = () => {
  ...
  const getStatusColor = (status: KetQua['trangThaiKetQuaTongThe']) => {
    switch (status) {
  ...
  return (
    <div style={{ maxWidth: 700, margin: "auto", padding: 20 }}>
      <Title level={3} style={{ textAlign: "center", marginBottom: 30 }}>Cổng Tra Cứu Kết Quả Tuyển Sinh Đại Học 2024</Title>
      <Input.Search
        placeholder="Nhập CCCD (ví dụ: 111111111, 222222222, 333333333, 444444444)"
        enterButton="Tra cứu"
        size="large"
        value={searchValue}
