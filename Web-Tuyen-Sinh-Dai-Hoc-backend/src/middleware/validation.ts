...
export const validateAdminSchool = [
  ...
  body('code')
    ...
    .matches(/^[A-Z0-9_]+$/)
    .withMessage('School code must be 2-20 characters, uppercase letters, numbers, and underscores only'),
  body('totalQuota')
    .isInt({ min: 1 })
...
export const validateAdminMajor = [
  ...
  body('code')
    ...
    .isLength({ min: 2, max: 20 })
    .matches(/^[A-Z0-9_]+$/)
    .withMessage('Major code must be 2-20 characters, uppercase letters, numbers, and underscores only'),
  body('quota')
    .isInt({ min: 1 })
