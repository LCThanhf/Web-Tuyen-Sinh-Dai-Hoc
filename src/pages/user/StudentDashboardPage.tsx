  ...
  return (
    <div>
      ...
      <div style={{ marginTop: 40, textAlign: 'center' }}>
        ...
        <Space size="large">
          <Button type="primary" size="large" onClick={() => navigate('/student/register-nguyenvong')}>Đăng ký nguyện vọng</Button>
          <Button size="large" onClick={() => navigate('/student/profile')}>Cập nhật thông tin cá nhân</Button>
        </Space>
      </div>
    </div>
  );
